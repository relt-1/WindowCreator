...
for i in keys:
    ...
    invert = Image.new("RGBA",(width,height),(0,0,0,0))
    drawline = ImageDraw.Draw(invert)
    drawline.rectangle((0,0,0,height),fill=(255,255,255,0))
    ...
    #screenshotfinal.save(".\\xp\\fonts\\text\\"+str(index+32)+".png","PNG")
    #screenshotfinal.save(".\\7\\fonts\\bigtext\\"+str(index+32)+".png","PNG")  #theme with selected text background set to #FFFF00 and text color #0000FF
    screenshotfinal.save(".\\7\\fonts\\bigtext\\white"+str(index+32)+".png","PNG")  #above but vice versa
    index += 1
    #print(invert.size)
